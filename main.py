...
bot = Client("DumperGPT", api_id=3769190, api_hash="e125d5abf9dadd0f9b861f774f5aae6a", bot_token="5941700911:AAGymJ6sZpmvYcsaMpyK5gEf6KY4wrlKrbY")
...
async def chatgpt(bot, msg):
    api = await bot.get_messages("qzpam", 2)
